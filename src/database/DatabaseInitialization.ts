...
export class DatabaseInitialization {
  ...
  private createTables(transaction: SQLite.Transaction) {
    ...
    `);
    transaction.executeSql(`
      CREATE TABLE IF NOT EXISTS FNCSALREP_FNCCONREP(
        ID INTEGER PRIMARY KEY AUTOINCREMENT,
        FNCSALREP_ID INTEGER,
        FNCCONREP_ID INTEGER,
    ...
    `);
    transaction.executeSql(`
      CREATE TABLE IF NOT EXISTS FNCSALREP(
        ID INTEGER PRIMARY KEY AUTOINCREMENT,
        WEB_ID TEXT DEFAULT NULL,
        EDAD_PRIMERA_REGLA INTEGER,
        GRAVIDEZ INTEGER,
        PARIDEZ INTEGER,
        ABORTO INTEGER,
        CESAREA TEXT,
        ...
        EDAD_GESTACION TEXT,
        PARTO_ESTIMADO TEXT,
        PRESENCIA_FAM INTEGER,
        SEROLOGIA INTEGER,
        VIH INTEGER,
        RESUL_CITOLOGIA TEXT,
        ACCION_CITOLOGIA INTEGER,
        RESUL_PROSTATA TEXT,
        ACCION_PROSTATA INTEGER,
        FNCPERSON_ID INTEGER,
        ESTADO INTEGER DEFAULT 0
      );
    `);
