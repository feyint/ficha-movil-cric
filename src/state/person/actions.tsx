 ...
 * @param answer 
 */
export const saveAnswerLocal = (type: number, questionCode: string, answer: any) =>
 ...
 * @param questionItems 
 */
export function getQuestionByCode(questionCode: string, questionItems: PersonQuestion[]) {
  if (questionItems.length === 0) {
    setQuestionWithOptions();
  }
